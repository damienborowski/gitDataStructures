...
public class LinkedStackTests {
	...
	/**
	 * tests that calling the push() method on an empty stack puts the item into the stack
	 */
	...
	/**
	 * tests that calling the pop() method on a non-empty stack removes the top item
	 * from the stack
	 */
